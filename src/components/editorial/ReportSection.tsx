...
export default function ReportSection({ ordinal, id, title, children }: ReportSectionProps) {
  return (
    <section
      id={id}
      className="scroll-mt-24 border-t border-white/8 pt-10 first:border-t-0 first:pt-0"
    >
      <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
        <span className="font-mono text-sm tabular-nums tracking-tight text-(--text-muted)">
          {ordinal}
        </span>
